...
@Service
public class StudentServiceImpl111 implements StudentService {

    @Autowired
    private StudentDao studentDao;

    private Logger logger = Logger.getLogger(StudentServiceImpl111.class);
    ...
    public void generatorAdmissionCard(HttpServletResponse response) throws UnsupportedEncodingException, FileNotFoundException {
        //模板名称
        String templateName ="toPDF1.pdf";
        String path = "";
